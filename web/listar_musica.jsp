...
<html>
    <head>
        ...
        <title>MUBRAIN - LISTA DE MÚSICAS</title>  
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="color: white;">Código do Álbum</th>
                ...
                <tbody>
                    ...
                    <c:forEach items="${musicas}" var="musica">
                        <tr>
                            ...
                            <td style="color: white;"><c:out value="${musica.codigo_album}"/></td>                           
                            ...
                            <td class="text-center">                                       
                                <c:choose>
                                    <c:when test="${musica.codusuario == usuario}">
                                        <a href="sermu?acao=editar&codigo=${musica.codigo}" class="btn btn-primary" >Editar</a>
                                        <a href="sermu?acao=excluir&codigo=${musica.codigo}" class="btn" >
